...
import { LEFT_RIGHT_MARGIN_DEFAULT, MIN_SPACE, PAGE_WIDTH } from "@/constants/editor";
...
export default function Ruler() {
  ...
  const handleLeftDoubleClick = () => {
    setLeftMargin(LEFT_RIGHT_MARGIN_DEFAULT);
  };

  const handleRightDoubleClick = () => {
    setRightMargin(LEFT_RIGHT_MARGIN_DEFAULT);
  };
