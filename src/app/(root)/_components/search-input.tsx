  ...
  return (
    <div className="flex-1 flex items-center justify-center">
      <form onSubmit={handleSubmit} className="relative max-w-[720px] w-full">
        ...
        {/* {!value && (
          <div className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-gray-500 pointer-events-none hidden md:flex items-center gap-1">
            <p className="rounded px-2 py-1 text-xs font-semibold text-gray-700">
              ⌘K
            </p>
          </div>
        )} */}
